...
def isAccessible(x, y, x1, y1):
    ...
    if (x == x1):
        if (y > y1):
            if (cells[y][x] == 4 or cells[y][x] == 5 or cells[y][x] == 6
                    or cells[y][x] == 10 or cells[y][x] == 11
                    or cells[y][x] == 12 or cells[y][x] == 14
                    or cells[y1][x1] == 2 or cells[y1][x1] == 7
                    or cells[y1][x1] == 8 or cells[y1][x1] == 10
                    or cells[y1][x1] == 12 or cells[y1][x1] == 13
                    or cells[y1][x1] == 14):
                return (False)
            else:
                return (True)
        else:
            if (cells[y][x] == 2 or cells[y][x] == 7 or cells[y][x] == 8
                    or cells[y][x] == 10 or cells[y][x] == 12
                    or cells[y][x] == 13 or cells[y][x] == 14
                    or cells[y1][x1] == 4 or cells[y1][x1] == 5
                    or cells[y1][x1] == 6 or cells[y1][x1] == 10
                    or cells[y1][x1] == 11 or cells[y1][x1] == 12
                    or cells[y1][x1] == 14):
                return (False)
            else:
                return (True)
        ...
        if (x > x1):
            if (cells[y][x] == 1 or cells[y][x] == 5 or cells[y][x] == 8
                    or cells[y][x] == 9 or cells[y][x] == 11
                    or cells[y][x] == 13 or cells[y][x] == 14
                    or cells[y1][x1] == 3 or cells[y1][x1] == 6
                    or cells[y1][x1] == 7 or cells[y1][x1] == 9
                    or cells[y1][x1] == 11 or cells[y1][x1] == 12
                    or cells[y1][x1] == 13):
                return (False)
            else:
            ...
            if (cells[y][x] == 3 or cells[y][x] == 6 or cells[y][x] == 7
                    or cells[y][x] == 9 or cells[y][x] == 11
                    or cells[y][x] == 12 or cells[y][x] == 13
                    or cells[y1][x1] == 1 or cells[y1][x1] == 5
                    or cells[y1][x1] == 8 or cells[y1][x1] == 9
                    or cells[y1][x1] == 11 or cells[y1][x1] == 13
                    or cells[y1][x1] == 14):
                return (False)
            else:
                return (True)
...
def getSurrounds(x, y):
    ...
    return (x0, y0, x1, y1, x2, y2, x3, y3
            )  #order of cells- north,east,south,west
...
def main():
    ...
    while True:
        ...
        show(flood, state)
        # added try catch to switch to shortest path traversal
        try:
            API.moveForward()
        except:
            for row in range(16):
...
def shortestPath(x, y, xprev, yprev, orient, state):
    ...
    log('\n')  # seperate output
    traversed_path = []  # added to keep track of path
    ...
    while True:
        ...
        if (flood2[y][x] != 1):
            ...
            log(f'Mouse at: [{x}, {y}]')
            traversed_path.append([x, y])  # added to keep track of path
...
if __name__ == "__main__":
    main()
    API.ackReset()
    traversed_path = shortestPath(0, 0, 0, 0, 0, 0)
