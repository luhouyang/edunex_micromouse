...
def backtrace_bfs(x, y, orientation, wall_position, maze_state, fifo_queue,
    ...
    forward_trace = []
    full_trace = []
    # fifo_queue.insert(0, next_cell)
    # print(fifo_queue, next_cell, cell_parent_map)
...
# next move functions
def next_move_bfs(x, y, orientation, wall_position, maze_state, fifo_queue,
                  cell_parent_map):
    ...
    if (maze_state[y][x] == -1):
        ...
        if (next_cell in accessible_cells):
            ...
            return backtrace_bfs(x, y, orientation, wall_position, maze_state,
